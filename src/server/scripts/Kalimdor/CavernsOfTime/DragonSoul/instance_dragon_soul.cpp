					...
					if(Creature* creature = instance->GetCreature(DeathwingGUID))
						{
							...
							if (creature->GetHealthPct() > 95)
								{ creature->SetHealth(creature->GetMaxHealth()  * 0.8); }
							if (creature->GetHealthPct() < 81)
								{ creature->SetHealth(creature->GetMaxHealth()  * 0.6); }
							if (creature->GetHealthPct() < 61)
								{ creature->SetHealth(creature->GetMaxHealth()  * 0.4); }
							if (creature->GetHealthPct() < 41)
								{ creature->SetHealth(creature->GetMaxHealth()  * 0.2); }
