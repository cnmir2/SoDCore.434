...
void Spell::EffectSchoolDMG(SpellEffIndex effIndex)
{
    ...
    if (unitTarget && unitTarget->isAlive())
    {
        ...
        if (m_originalCaster && damage > 0 && apply_direct_bonus)
        {
            ...
            damage = unitTarget->SpellDamageBonusTaken(m_originalCaster, m_spellInfo, (uint32)damage, SPELL_DIRECT_DAMAGE, 1, m_originalCaster->GetGUID());
        }
...
void Spell::EffectPowerDrain(SpellEffIndex effIndex)
{
    ...
    damage = unitTarget->SpellDamageBonusTaken(m_caster, m_spellInfo, uint32(damage), SPELL_DIRECT_DAMAGE, 1, m_caster->GetGUID());
