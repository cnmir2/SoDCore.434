...
class Unit : public WorldObject
{
    public:
        ...
        void SetStandState(uint8 state);
		 uint32 GetMeleeCritDamageReduction(uint32 damage) const { return GetCombatRatingDamageReduction(CR_CRIT_TAKEN_SPELL, 2.2f, 33.0f, damage); }
        ...
        */
        ...
        uint32 SpellDamageBonusTaken(Unit* caster, SpellInfo const* spellProto, uint32 pdamage, DamageEffectType damagetype, uint32 stack = 1, uint64 casterGUID = 0);
