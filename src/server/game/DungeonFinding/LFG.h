...
{
    LfgLockInfoData(uint32 _lockData = 0, uint16 _requiredItemLevel = 0, float _currentItemLevel = 0) :
        lockData(_lockData), requiredItemLevel(_requiredItemLevel), currentItemLevel(_currentItemLevel) { }
