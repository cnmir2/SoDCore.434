...
int Master::Run()
{
    ...
    sLog->outInfo(LOG_FILTER_WORLDSERVER, "SoDCore 2010-2015");
    sLog->outInfo(LOG_FILTER_WORLDSERVER, "Visit our forum project.sanctum-of-darkness.de");
    sLog->outInfo(LOG_FILTER_WORLDSERVER, "SoDCore 4.3.4");
